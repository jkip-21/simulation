...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarSupportedContent">
        ...
        <div class="justify-content-end">
            <a href="http://127.0.0.1:8000/"><button type="button" style="margin-right: 40px;" class="btn">LOG OUT</button></a>
        </div>
    </div>
</nav>
    ...
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white"
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="http://127.0.0.1:8000/courses/">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="/wp/simulation/message/">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class='card-header'>
                            ...
                            if (isset($_POST['cpt_nonce_field']) && wp_verify_nonce($_POST['cpt_nonce_field'], 'cpt_nonce_action')) {
                                ...
                                if (!empty($assigned_courses)) {
                                    ...
                                    $course_desc = sanitize_text_field($_POST['description']);
                                    $course_start_date = sanitize_text_field($_POST['start']);
                                    $course_due_date = sanitize_text_field($_POST['due']);
                                    $course_status = 'Pending';
                                    $course_user = intval($_POST['user']);

                                    $new_course = array(
                                        'post_title' => $course_title,
                                        'post_content' => $course_desc,
                                        'post_status' => 'publish',
                            ...
                            <div class='form-field1'>
                                <form method="post" action="">
                                    ...
                                    <div class='row  justify-description-center'>
                                        <div class='col'>
                                            <label for='title'>
                                                <?php _e('course Title:', 'mytextdomain'); ?>
                                            </label><br>
                                        ...
                                        ?>
                                        <div class='col'>
                                            <label for='user'>Assign Students:</label><br>
                                            <select class="form-control js-example-basic-multiple" id="user" name="user" required>
                                                <option value="">Assign Students:</option>
                                ...
                                <div class='row justify-description-center'>
                                    ...
                                    <div class='form-outline mb-4 '>
                                        <label class='form-label' for='textAreaExample6'>
                                            <?php _e('course Description:', 'mytextdomain'); ?>
                                        </label>
