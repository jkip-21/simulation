...
<div class="new">
  <div class="row justify-content-center">
    ...
    <h1 style="text-align: center;">ADD COORDINATOR</h1>
    <?php
    ...
    <div class="form-group">
        <label for="name" style="color: #090D5A; font-weight: w800; font-size: 20px"><?php _e('Name:', 'mytextdomain');?></label>
        <input type="text" class="form-control input-sm mb-4" name="name" id="name" ,
          placeholder="Enter coord name..." required style="border: 1px solid #090D5A">
      </div>
      <div class="form-group">
        ...
        <input type="email" class="form-control input-sm mb-4" name="useremail" id="email" ,
          placeholder="Enter coord email..." required style="border: 1px solid #090D5A">
      </div>
      <div class="form-group">
        <label for="phone" style="color: #090D5A; font-weight: w800; font-size: 20px"><?php _e('Phone:', 'mytextdomain');?></label>
        <input type="number" class="form-control input-sm mb-4" name="phone" id="phone" ,
          placeholder="Enter coord phone..." required style="border: 1px solid #090D5A">
      </div>
