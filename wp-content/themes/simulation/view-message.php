...
<li class = 'nav-item'>
<a class = 'nav-link  ' href = '/wp/vanced/course/'>
<div
...
<li class = 'nav-item'>
<a class = 'nav-link  ' href = '/wp/vanced/add-course/'>
<div
...
<table class="table table-sm" style="width:40vw; box-shadow:3px 3px 3px 3px 3px grey; padding:30px;">
    <thead>
        <tr>
            <th>Email</th>
            <th>Message</th>
