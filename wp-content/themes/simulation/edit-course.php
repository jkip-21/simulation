                ...
                <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white"
                    ...
                    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  " href="/wp/simulation/add-project/">
                                    <div
                                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                                ...
                                                <div class='row  justify-description-center'>
                                                    <div class='col'>
                                                        ...
                                                        <input type='text' class='form-control' name='title'
                                                            ...
                                                            value="<?php echo the_title(); ?>" required>
                                                    </div>
                                                    <?php
                                                    ...
                                                    <div class="col">
                                                    <label for='user'>Project Status:</label><br>
