...
<link rel = 'stylesheet' href = '/wp-content/themes/simulation/assets/css/advanced.css'>
<link rel = 'stylesheet' href = '/wp-content/themes/simulation/assets/css/add.css'>
<link rel = 'stylesheet' href = '/wp-content/themes/simulation/assets/css/test.css'>
</head>
<style>
a .btn {
...
id = 'sidenav-main' style = 'height: 60%'>
...
<li class = 'nav-item'>
<a class = 'nav-link  ' href = '/wp/simulation/dashboard/'>
<div
...
<li class = 'nav-item'>
<a class = 'nav-link  ' href = '/wp/simulation/project/'>
<div
...
<li class = 'nav-item'>
<a class = 'nav-link  ' href = 'http://127.0.0.1:8000/add-course/'>
<div
...
<li class="nav-item">
                    <a class="nav-link  " href="http://127.0.0.1:8000/view-message/">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Add Coordinator</span>
                    </a>
                </li>
<li class="nav-item">
                    <a class="nav-link  " href="http://127.0.0.1:8000/view-message/">
...
<div class="col-xl-3 col-sm-6">
    ...
    ?>
                                        ...
                                        <h5 class="text-success mb-0 font-weight-bolder"><?php echo $total_courses ?></h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div
...
if (isset($_POST[ 'accepted' ])) {
    ...
    update_post_meta($post_id, 'course_status_select', $new_value);
}

if (isset($_POST[ 'completed' ])) {
    $post_id = $_POST[ 'course-id' ];
...
if ($query->have_posts()):
    while ($query->have_posts()) :
        ...
        // $course_desc = get_post_meta(get_the_ID(), 'course_desc', true);
...
<td><b><?php echo esc_attr($course_start) ;
        ?></b></td>
<td>
<b><?php echo esc_attr($course_end) ;
        ?></b>
</td>
<td>
<span <?php if ($course_status == 'Pending') {
...
<td>
<span class = ''><?php echo esc_attr($course_user) ;
        ?></span>
</td>
<td>
...
<input type = 'hidden' name = 'meta-field' value = "<?php echo get_post_meta(get_the_ID(), 'course_user', true); ?>">
