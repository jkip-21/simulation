...
<head>
    ...
    <script src="../wp-content/themes/simulation/assets/js/simulation.js"></script>
    ...
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white"
        ...
        <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="/wp/simulation/course/">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="/wp/simulation/add-course/">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="text-success mb-0 font-weight-bolder">
                                        <?php echo '' . $user_count['avail_roles']['developer'];?>
                                        </h5>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
            ...
            <tbody>
                ...
                foreach ($users as $user) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo '<span>' . esc_html(date("d-m-Y", strtotime($user_register))) . '</span>'; ?>
                        </td>
                        <td>
