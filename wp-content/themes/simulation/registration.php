...
<div class="container register">
    <div class="row">
        <div class="col-md-3 register-left">
            ...
            <h3>What is personal information? | Personal data</h3>
            <p>Personal information is any information that can identify a person, from someone's name and address to their device identifier and account number.</p>

        </div>
        <div class="col-md-9 register-right">

            <form action="http://127.0.0.1:8000/org-data/" method="post">
...
try {
    ...
    if ($existing_user) {
        ...
        $stmt = $conn->prepare("INSERT INTO students (surname, other_names, date_of_birth, nationality, gender, component, title_rank, telephone, private_email) 
        VALUES (:surname, :other_names, :date_of_birth, :nationality, :component, :title_rank, :telephone, :private_email)");
        ...
        $stmt->bindParam(':component', $_POST['component']);
        $stmt->bindParam(':title_rank', $_POST['title_rank']);
        $stmt->bindParam(':telephone', $_POST['telephone']);
        $stmt->bindParam(':private_email', $_POST['private_email']);
