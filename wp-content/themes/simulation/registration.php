                    ...
                    <div class="row register-form">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <input type="text" class="form-control" placeholder="Surname/Family Name *" value="" />
                            </div>
                            <div class="form-group mb-3">
                                <input type="text" class="form-control" placeholder="Other Names *" value="" />
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" class="form-control" placeholder="Title/Rank *" value="" />
                            </div>
                            <div class="form-group mb-3">
                                <input type="tel" class="form-control" placeholder="Telephone Number *" value="" />
                            </div>
                            <div class="form-group mb-3">
                                <input type="email" class="form-control" placeholder="Private Email *" value="" />
                            </div>
                            <a href="http://127.0.0.1:8000/org-data/">
